...
package com.example.rafaela.activitylifecycle.util;
...
public class Utils {
    ...
    private static com.example.rafaela.activitylifecycle.util.StatusTracker mStatusTracker = com.example.rafaela.activitylifecycle.util.StatusTracker.getInstance();
